...
export default function Toast({ type, message, id }) {
  ...
  return (
    <>
      ...
      {type === 'info' && (
        <div className='rounded-md bg-sky-50 p-4 m-3'>
          <div className='flex'>
            <div className='flex-shrink-0'>
              <svg
            ...
            <div className='ml-auto pl-3'>
              <div className='-mx-1.5 -my-1.5'>
                <button
                  ...
                  className='inline-flex bg-sky-50 rounded-md p-1.5 text-sky-500 hover:bg-sky-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-sky-50 focus:bg-sky-600'>
                  <span className='sr-only'>Dismiss</span>
